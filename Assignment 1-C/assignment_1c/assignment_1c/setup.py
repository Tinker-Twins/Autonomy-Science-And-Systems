...
setup(
    ...
    description='Assignment 1C for the course AuE-8230 "Autonomy: Science and Systems" at CU-ICAR (Spring 2023)',
    license='BSD',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'circle = assignment_1c.circle:main', # Python script
            'square = assignment_1c.square:main', # Python script
        ],
    },
)
