...
The following `collapsible sections` highlight the high-level outcomes of each task. Furthermore, `dedicated directories` for each of the milestones has a detailed `README.md` of their own.
